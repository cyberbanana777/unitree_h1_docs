...
- [4. 👨‍💻 Практическое программирование под H1](#4-практическое-программирование-под-h1)
  ...
  - [4.3. High-Level клиент (Команды верхнего уровня)](#42-high-level-клиент-команды-верхнего-уровня)
  - [4.4. Low-Level (Прямое управление всеми моторами)](#43-low-level-прямое-управление-всеми-моторами)
  - [4.5. Low-Level (Гибридное управление: ходьба + руки)](#44-low-level--гибридное-управление-ходьба--руки)
  - [4.6. Наш код для управления](#45-наш-код-для-управления)
