...
Посмотреть дерево соединений можно командой (если происходит публикация TF-преобразований т.е. публикуются сообщения в /tf топики — см. [методический материал 14]()):
